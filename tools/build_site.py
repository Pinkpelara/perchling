...
def og(images):
    ...
    d.text((74, 190), "A tiny 3D pet for your desktop.", font=font(38, bold=False), fill=(90, 63, 192, 255))
    d.text((74, 244), "It lives at the bottom of your screen and walks around while you do your thing. $1.99, one time.", font=font(26, bold=False), fill=(107, 102, 133, 255))
    x = 120
    for pet in PETS:
