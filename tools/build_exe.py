...
def readme(ver):
    ...
    return nl.join([
        ...
        "3. The first time, it asks which pet you adopted, what to call it, and which 5 things it can do.",
        "4. Your pet appears at the bottom of the screen. Right-click it for the menu.",
        "",
