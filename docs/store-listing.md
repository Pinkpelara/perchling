...
Paste-ready text for the payment provider's product page and its emails. Same voice as the site (see `writing.md`): plain, calm, no exclamation marks.
...
What's in the box: the app, your pet, and 5 picks from its list of tricks and habits (bounce, peekaboo, zoomies, sit, lie down, spin, wave, nap anywhere, calm, sleepy, clingy, show-off). The closet has hats, glasses and headphones to start.
...
**Subject:** Your Perchling is ready

Thanks for adopting one.
